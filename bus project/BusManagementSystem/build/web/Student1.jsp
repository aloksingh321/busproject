...
<span id="a" class="in" onclick="fun()"><i class="fa fa-user" style="font-size:25px;color:black; margin:5px"></i>Feedback</span>
<span id="c" class="in2" onclick="fun2()"><i class="fa fa-refresh" style="font-size:25px;color:black; margin:5px"></i>fee Detail</span>
<span id="d" class="in3" onclick="fun3()"><i class="fa fa-trash-o" style="font-size:25px;color:black; margin:5px"></i>Notification</span>
</div>
